...
export const metadata: Metadata = {
  ...
  description:
    "Guide pas-à-pas pour signaler un produit au faux étiquetage vegan sur Signal Conso. Modèles de texte prêts à copier, captures d'écran du processus et liste des éléments à préparer.",
};
